...
enum
{
	...
	NET_PACKETFLAG_UNUSED=1<<0, // 1
	NET_PACKETFLAG_TOKEN=1<<1, // 2
	NET_PACKETFLAG_CONTROL=1<<2, // 4
	NET_PACKETFLAG_CONNLESS=1<<3, // 8
	NET_PACKETFLAG_RESEND=1<<4, // 16
	NET_PACKETFLAG_COMPRESSION=1<<5, // 32
...
public:
	...
	static int UnpackPacket(NETADDR *pAddr, unsigned char *pBuffer, int Size, CNetPacketConstruct *pPacket);
